...
const DailyWeather = ({ weather }: { weather: FormattedData }) => {
  ...
  return (
    <div className="wrapper">
      <h3 className="heading-md">8-Day Forecast</h3>
          ...
          >
            <div className="flex gap-4">
              ...
              <div className="grid items-center flex-1 gap-1 md:grid-cols-2 md:gap-4">
                <p className="heading-sm leading-4 text-left">
                  {i !== 0
                    ? dayjsExtended
            ...
            <div className="flex flex-col gap-1 text-right">
              ...
              <p
                className={`heading-sm px-2 text-muted self-end card-border min-w-28 text-center ${tempColor}`}
