const WindIcon = () => (
  <svg
    className="inline w-8 h-8 mr-2 rounded-sm bg-cool"
    name="wind"
    data-testid="Icon"
    aria-hidden="true"
    role="img"
...
const VisibilityIcon = () => (
  <svg
    className="inline w-8 h-8 p-1 mr-2 rounded-sm bg-milder"
    name="visibility"
    data-testid="Icon"
    aria-hidden="true"
    role="img"
...
const PressureIcon = () => (
  <svg
    className="inline w-8 h-8 mr-2 rounded-sm bg-hot"
    name="pressure"
    data-testid="Icon"
    aria-hidden="true"
    role="img"
...
const DewpointIcon = () => (
  <svg
    className="inline w-8 h-8 mr-2 rounded-sm bg-mild"
    name="dewpoint"
    data-testid="Icon"
    aria-hidden="true"
    role="img"
